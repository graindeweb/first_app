  ...
  describe "GET 'posts'" do
    ...
    describe "for non-signed-in users" do
      it "should deny access" do
        ...
        flash[:notice].should =~ /Merci de vous authentifier/i
      end
    end
    ...
    describe "for signed-in users" do
      before(:each) do
        @user = Factory(:user)
        test_sign_in(@user)
        ben = Factory(:user, :name => 'Ben', :email => 'Ben@example.net')
        jerry  = Factory(:user, :name => 'Jerry', :email => 'Jerry@example.net')
        @users = [@user, ben, jerry]
        30.times do
      ...
      it "should paginate users" do
        ...
        response.should have_selector("span.disabled", :content => "précédent")
  ...
  describe "POST 'create'" do
    ...
    describe "success" do
      ...
      it "should have a welcome message" do
        post :create, :user => @attr
        flash[:success].should =~ /Bienvenue sur la première application/i
      end
...
#    describe "failure" do
#      it "should not give access to non-authenticated user " do
#        controller.sign_out
#        get :edit, :id => 1
#        response.should redirect_to(root_path)
#        flash[:error].should =~ /accès non authorisé/i
#      end
#    end

    describe "with signin user" do
      before(:each) do
        @user = Factory(:user)
        test_sign_in(@user)
      end
      ...
      it "should have the right title" do
        get :edit, :id => @user
        response.should have_selector('title', :content => 'Modification')
      end
  ...
  describe "POST 'update'" do
    ...
    describe "success" do
      ...
      it "should have a flash message" do
        put :update, :id => @user, :user => @attr
        flash[:success].should =~ /mis à jour/
      end
    end

  end

  describe "auth of edit / update pages" do
